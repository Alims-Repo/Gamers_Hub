...
public class Config {
    ...
    public static final String SEARCH_URL = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=relevance&maxResults=10&q="+"Free+Fire";
    ...
    public static final String  NEXTPAGE2 = "&part=snippet&maxResults=10&q="+"Free+Fire"+"&key="+API_KEY+"";
